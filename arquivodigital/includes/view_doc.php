	...
	if(isset($_GET['M'])){
 	...
 	echo"
		<div class='form-group ' style='width:100px!important;'>
			<input type='numero' class='form-control' name='numero' value='$numero' required='required' readonly='readonly'>
		</div>
	  
      <div class='form-group has-feedback'>
        <select name='num_utilizador' class='btn btn-default dropdown-toggle' required='required' style='text-align:left!important;' disabled>
			...
			echo"		  	
			  		...
			  		echo"
	   <div class='form-group has-feedback'>
        <select name='departamento'  class='btn btn-default dropdown-toggle' required='required' style='text-align:left!important; width:270px!important;' disabled>
	  ...
	  echo" 
	  	  <div class='form-group has-feedback'>
        <select name='documento'  class='btn btn-default dropdown-toggle' required='required' style='text-align:left!important; width:270px!important;' disabled>
	  ...
	  <div class='form-group has-feedback' style='width:270px!important;'>
        <input type='date' class='form-control' required='required'name='data' placeholder='Data:  AAAA-MM-DD' value='$data' required='required' readonly='readonly'>
        <span class='glyphicon glyphicon-calendar form-control-feedback' ></span>
      </div>
	  
      <div class='form-group has-feedback'>
        <input type='text' class='form-control' required='required'name='assunto' placeholder='Assunto: 'required='required' value='$assunto' readonly='readonly'>
        <span class='glyphicon glyphicon-comment form-control-feedback' ></span>
      </div> 
	  
	  <div class='form-group has-feedback'>
        <input type='text' class='form-control' required='required'name='destinatarios' placeholder='Destinatario: ' value='$destinatario'required='required' readonly='readonly'>
